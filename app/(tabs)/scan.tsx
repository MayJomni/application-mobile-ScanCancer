...
import { LESION_TYPES, getRiskColor, getRiskLabel } from '@/constants/Lesions';
...
export default function ScanScreen() {
  ...
  const analyzeImage = () => {
    ...
    setTimeout(() => {
      const preds = simulatePrediction();
      setResults(preds);
      setAnalyzing(false);
      ...
      >
        ...
        >
          ...
          <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
            Analysez une lésion cutanée avec l'IA
          </Text>
        </Animated.View>
            ...
            <View style={styles.imageContainer}>
              ...
              {analyzing && (
                <View style={styles.analyzingOverlay}>
                  <LinearGradient
                    colors={['rgba(37, 99, 235, 0.9)', 'rgba(124, 58, 237, 0.9)']}
        ...
        {results && topResult && (
          <Animated.View style={{ opacity: resultFade }}>
            ...
            <Card variant="elevated" style={styles.resultCard}>
              <View style={styles.resultHeader}>
                <View
                  style={[
                    styles.riskBadge,
                    { backgroundColor: getRiskColor(topResult.riskLevel) + '15' },
                  ]}
                >
                  <View
                    style={[
                      styles.riskDot,
                      { backgroundColor: getRiskColor(topResult.riskLevel) },
                    ]}
                  />
                  <Text
                    style={[
                      styles.riskText,
                      { color: getRiskColor(topResult.riskLevel) },
                    ]}
                  >
                    {getRiskLabel(topResult.riskLevel)}
                  </Text>
                </View>
              ...
              <Text style={[styles.resultName, { color: colors.textSecondary }]}>
                {topResult.name}
              </Text>
              <Text style={[styles.resultDesc, { color: colors.textSecondary }]}>
                {topResult.descriptionFr}
              </Text>
              ...
              <View style={styles.confBarContainer}>
                <View style={[styles.confBarBg, { backgroundColor: colors.separator }]}>
                  <LinearGradient
                    colors={[
                      getRiskColor(topResult.riskLevel),
                      getRiskColor(topResult.riskLevel) + 'AA',
                    ]}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 0 }}
                    style={[
                      styles.confBarFill,
                      { width: `${topResult.confidence * 100}%` },
                    ]}
                  />
                </View>
              </View>
              ...
              <View
                style={[
                  ...
                  { backgroundColor: getRiskColor(topResult.riskLevel) + '08' },
                ]}
              >
                <Ionicons
                  name="medical"
            ...
            {results.slice(0, 5).map((pred, index) => (
              <Card
                key={pred.id}
                variant="outlined"
                style={[styles.predCard, { marginBottom: Spacing.sm }]}
                padding="sm"
              >
                <View style={styles.predRow}>
                  <Text style={styles.predIcon}>{pred.icon}</Text>
                  <View style={styles.predContent}>
                    <Text style={[styles.predName, { color: colors.text }]}>
                      {pred.nameFr}
                    </Text>
                  ...
                  <Text style={[styles.predConfidence, { color: colors.textSecondary }]}>
            ...
            <View style={styles.resultActions}>
              ...
              >
                ...
                >
                  ...
                  <Text style={styles.resultActionText}>Nouvelle analyse</Text>
                </LinearGradient>
              </TouchableOpacity>
            </View>
          </Animated.View>
        ...
        {!image && !results && (
          ...
          >
            ...
            {[
              ...
              { icon: 'resize-outline', text: 'Cadrez la lésion au centre de l\'image' },
              ...
              <View
                key={index}
                style={[styles.tipRow, { borderBottomColor: colors.separator }]}
              >
